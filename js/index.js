...
import {randonNumber, pickRndFromArray } from './utils.js'
...
const WORLD = {
  width: worldclass.clientWidth - 150,
...
function initiate(amount) {
  for (let index = 0; index < amount; index++) {
    busArray.push(new Bus(generateVehicleName(), generateColorName(), 3, randonNumber(WORLD.width), randonNumber(WORLD.height)));
   }
}
